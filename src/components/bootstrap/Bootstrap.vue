<template>
  <div class="bootstrap-pro">
    <ul class="bootstrap-wrapper container">
      <li class="col-sm-2 empty"></li>
      <li class="item-wrapper col-sm-4" v-for="(item,index) in bootstrapPro">
        <div class="item">
